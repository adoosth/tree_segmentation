...
# define DataLoader
def get_dataloader(data_dir, csv, batch_size = 8, num_workers = 8, max_trees = 100, point_count = 4096, sampling='random', preload=True, center=True, normalize=True, select_trees = None, annotated = None, aug_rot = False, chunk_size = 4000000, distributed=False, world_size=1, world_rank=0):
