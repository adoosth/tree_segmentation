...
class SGPN(nn.Module):
    def __init__(self,latent_dims = 128):
        ...
        self.sa0 = PointNetSetAbstraction(4096, 0.1, 32, 3, [16, 16, 32], False) # input: B x 3 x N, output: B x 32 x N
        ...
        #self.fp1 = PointNetFeaturePropagation(160, [128, 128, 128]) 
        ...
        # These are for semantic segmentation
    ...
    def forward(self, xyz, test = False):
        ...
        # l0_xyz, l0_points = self.sa0(xyz, None)
        ...
        # #l0_points = self.fp0(xyz, l0_xyz, None, l0_points)
...
class SGPNLoss(nn.Module):
    ...
    def forward(self, l0_points, Fsim, conf, target, alpha = 2.0, margin = 0.8):
        ...
        print("Simmat loss: ", simmat_loss.item(), "Confidence loss: ", confidence_loss.item())
