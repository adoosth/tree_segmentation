...
if __name__ == '__main__':
    ...
    forests.sort()
    build_dataset(forests, dataset_dir, 400, (40,40), 'train.csv', epochs = 1000)
    build_dataset(forests, dataset_dir, 8, (40,40), 'test.csv', test = True, epochs = 100)
    build_dataset(forests, dataset_dir, 8, (40,40), 'sanity.csv', sanity=True, epochs = 1000)
