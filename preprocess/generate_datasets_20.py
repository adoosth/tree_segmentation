...
if __name__ == '__main__':
    ...
    forests.sort()
    build_dataset(forests, dataset_dir, 400, (20,20), 'train_20.csv', epochs = 1000)
    build_dataset(forests, dataset_dir, 8, (20,20), 'test_20.csv', test = True, epochs = 100)
    build_dataset(forests, dataset_dir, 8, (20,20), 'sanity_20.csv', sanity=True, epochs = 1000)
